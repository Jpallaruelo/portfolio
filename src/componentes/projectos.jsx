...
const ProjectosPage = () => {
    ...
    const projects = [
        { id: 1, title: "TASKS", image: "images/task.jpg", path: "/tareas" },
        { id: 2, title: "PARTICLES", image: "images/particles.webp", path: "/particles" },
        { id: 3, title: "CRIPTOS", image: "images/cryptos.jpg", path: "/cryptos" },
        { id: 4, title: "CARD", image: "images/redux.jpg", path: "/cartMain" },
